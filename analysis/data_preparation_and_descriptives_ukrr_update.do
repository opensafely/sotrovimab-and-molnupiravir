...
* Open a log file
cap log close
log using ./logs/data_preparation_ukrr_update, replace t
clear
...
keep if start_date>=mdy(12,16,2021)&start_date<=mdy(05,15,2022)
drop if region_nhs==""
...
save ./output/ukrr/main_ukrr_update.dta, replace
