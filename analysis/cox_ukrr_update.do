...
* Open a log file
cap log close
log using ./logs/cox_ukrr_update, replace t
clear

use ./output/ukrr/main_ukrr_update.dta
...
graph export ./output/ukrr/phtest_update.svg, as(svg) replace
...
graph export ./output/ukrr/psgraph_update.svg, as(svg) replace
drop psweight
gen psweight=cond( drug ==1,1/_pscore,1/(1-_pscore)) if _pscore!=.
sum psweight,de
by drug, sort: sum _pscore ,de
...
estat phtest,de
estat phtest, plot(1.drug)
graph export ./output/ukrr/phtest_psw_update.svg, as(svg) replace
