...
* Open a log file
cap log close
log using ./logs/cox_archive, replace t
clear

use ./output/archive/main_archive.dta
...
graph export ./output/archive/phtest.svg, as(svg) replace
...
estat phtest,de
estat phtest, plot(1.drug)
graph export ./output/archive/phtest_psw.svg, as(svg) replace
