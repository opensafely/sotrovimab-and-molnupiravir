...
* Open a log file
cap log close
log using ./logs/data_preparation_update_codelist, replace t
clear

* import dataset
import delimited ./output/update_codelist/input_update_codelist.csv, delimiter(comma) varnames(1) case(preserve) 
describe
codebook
...
save ./output/update_codelist/main_update_codelist.dta, replace
