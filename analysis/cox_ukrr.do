...
by drug, sort: stcox age i.sex downs_syndrome solid_cancer_new haema_disease i.years_since_rrt i.rrt_mod_Tx liver_disease imid immunosupression_new hiv_aids solid_organ_new rare_neuro b1.White b5.imd i.vaccination_3 calendar_day_spline*, strata(region_nhs)
...
by drug, sort: stcox age i.sex downs_syndrome solid_cancer_new haema_disease i.years_since_rrt i.rrt_mod_Tx liver_disease imid immunosupression_new hiv_aids solid_organ_new rare_neuro b1.White b5.imd i.vaccination_3 calendar_day_spline* b1.bmi_g3 diabetes chronic_cardiac_disease hypertension chronic_respiratory_disease, strata(region_nhs)
...
by drug,sort: stcox age i.sex if d_postest_treat>=0&d_postest_treat<=5, strata(region_nhs)
...
by drug,sort: stcox  age i.sex if _t>=2, strata(region_nhs)
...
by drug,sort: stcox  age i.sex if _t>=3, strata(region_nhs)
...
by drug, sort: stcox age i.sex if death_with_covid_underlying_date!=.|death_with_covid_on_the_death_ce!=end_date, strata(region_nhs)
