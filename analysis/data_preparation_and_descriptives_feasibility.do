...
foreach var of varlist  sotrovimab_covid_out molnupiravir_covid_out paxlovid_covid_out remdesivir_covid_out casirivimab_covid_out date_treated_out ///
		...
		ckd_stage_5_nhsd ckd_stages_3_5  ckd3_icd10  ckd4_icd10 ckd5_icd10 liver_disease_nhsd last_vaccination_date covid_hosp_not_pri_admission covid_hosp_not_pri_discharge  ///
		covid_hosp_not_pri_discharge2 covid_hosp_not_pri_admission2     all_hosp_admission2  ///
		...
		emergency_care emergency_care0 emergency_care2 emergency_care_index emergency_care2_index emergency_care3_index {
...
gen emergency_d=start_date - emergency_care
sum emergency_d,de
gen emergency2_d=start_date - emergency_care2
sum emergency2_d,de
